...
const Main = () => {
  return (
    <div
      className="w-full h-screen bg-cover bg-center z-10 flex flex-row"
      style={{ backgroundImage: `url("/assets/chess.jpg")` }}
    >
      ...
      <div className='flex flex-col w-1/2 pl-10 h-1/2 pt-72'>
        <div className=' w-2/3 flex flex-col items-center'>
          ...
          <Link href="/game">
            <button className='mt-10 bg-white text-black text-3xl font-lancelot font-semibold px-10 py-2 rounded-lg border-2 border-black'>
              Empezar
            </button>
          </Link>
        </div>
